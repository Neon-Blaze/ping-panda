...
export const MockDiscordUI = ({ children }: PropsWithChildren) => {
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overfloe-hidden shadow-xl">
      {/* server list  */}
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        <div className="px-4 h-16 border-b border-[#20225] flex items-center shadow-sm">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="px-2 mb-4">
            ...
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcddde] cursor-not-allowed">
              <Zap className="mr-4 size-8 text-[#b9bbbe]" />
        ...
        <div className="p-2 bg-[#292b2f] flex items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Settings className="size-5 text-[#b9bbbe] hover:text-white cursor-pointer" />
          </div>
        </div>
      </div>
